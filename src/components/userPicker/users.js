...
.service('newDataService',['$http', function($http){
  ...
  return{
    getData: function(){
      $http.get('http://ec2-52-91-217-242.compute-1.amazonaws.com:8080/').then(function(response) {
...
.controller('dataSaveController', ['$scope', '$http', 'newDataService', 'newDataServiceForPurchased', function ($scope, $http, newDataService, newDataServiceForPurchased) {
  ...
  $scope.viewArrayPushing = function(id){
    ...
    $http.post("http://ec2-52-91-217-242.compute-1.amazonaws.com:8080/viewed", data).success(function(data, status) {
  ...
  $scope.buyArrayPushing = function(id){
    ...
    $http.post("http://ec2-52-91-217-242.compute-1.amazonaws.com:8080/purchased", data).success(function(data, status) {
  ...
  $scope.restart = function(){
    ...
    $http.post("http://ec2-52-91-217-242.compute-1.amazonaws.com:8080/delete", data).success(function(data, status) {
