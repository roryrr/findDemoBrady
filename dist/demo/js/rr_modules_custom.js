...
/* jshint ignore:start */
jQuery('#eb-overlay').attr('ng-jq', 'jQueryEB');
window.jQueryEB = jQuery.noConflict(true);
/* jshint ignore:end */
...
angular.module('ebCustomTemplates', ['components/empathize/empathize.html', 'components/facet/facet-item.html', 'components/facet/facet.html', 'components/facets/facets.html', 'components/no-results/no-results.html', 'components/result/result.html', 'components/scroll-to-top/scroll-to-top.html', 'components/sort/sort.html', 'components/spellcheck/spellcheck.html', 'components/userPicker/userPicker.html', 'structure/default/main/main.html', 'structure/default/overlay.html', 'structure/default/utils-bar/utils-bar.html', 'commons/icons/checkbox/default/default.html', 'commons/icons/loading/custom/custom.html']);

angular.module("components/empathize/empathize.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("components/empathize/empathize.html",
    "<ul data-ng-class=\"{'eb-empathize-history': $ctrl.showHistory()}\"><li data-ng-if=$ctrl.showHistory() data-ng-repeat=\"(i, term) in $ctrl.getHistory() | orderBy:'$index':true | limitTo: $ctrl.ebFeatures.components.empathize.limit\" data-ng-mousedown=\"$ctrl.onTermClick($event, term)\" data-ng-class=\"{'eb-empathize-selected': $ctrl.isSelected(i)}\" style=\"background-color: rgba(255, 255, 255, {{0.06 * $index}})\"><span class=\"eb-clock hours\" data-ng-include=\"'images/FixedHour.svg'\"></span> <span class=\"eb-clock minutes\" data-ng-include=\"'images/Rotate-mins.svg'\"></span> {{term}}</li><li data-ng-if=!$ctrl.showHistory() data-ng-repeat=\"(i, term) in $ctrl.ebSearch.getTopTrends() | limitTo: $ctrl.ebFeatures.components.empathize.limit\" data-ng-mousedown=\"$ctrl.onTermClick($event, term.term)\" data-ng-bind-html=term.html data-ng-class=\"{'eb-empathize-selected': $ctrl.isSelected(i)}\"></li></ul>");
}]);

angular.module("components/facet/facet-item.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("components/facet/facet-item.html",
    "<a><data-ng-include data-ng-if=$ctrl.ebFeatures.bodyFacetsCheck data-src=$ctrl.cbxPath></data-ng-include>{{$ctrl.getValue(value.value)}} <span class=eb-facet-count>({{value.count}})</span></a><ul class=eb-sub-facet data-ng-if=value.child><li data-ng-repeat=\"value in value.child.values\" data-ng-class=\"{ 'eb-selected': $ctrl.ebState.isSelectedFilter(value.filter)}\" data-ng-include=\"'components/facet/facet-item.html'\" data-facet-item=value></li></ul>");
}]);

angular.module("components/facet/facet.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("components/facet/facet.html",
    "<div class=eb-header-facet data-ng-class=\"{'eb-collapsable': $ctrl.ebFeatures.bodyFacetsOpenClose, 'eb-collapsed': $ctrl.isCollapsed($ctrl.facet)}\" data-ng-click=\"$ctrl.ebFeatures.bodyFacetsOpenClose ? $ctrl.toggleFacet($ctrl.facet) : false\">{{('FACET_TITLE.' + ($ctrl.facet.facet | uppercase)) | translate}} <span data-ng-if=\"$ctrl.getSelectedCount($ctrl.facet.facet) > 0\">({{$ctrl.getSelectedCount($ctrl.facet.facet)}})</span><data-ng-include data-ng-if=$ctrl.ebFeatures.bodyFacetsOpenClose data-ng-class=$ctrl.ebFeatures.icons.toggleFacetAnimation data-src=$ctrl.toggleIconPath></data-ng-include></div><div class=eb-facet><div id=eb-facet-mobile-header><button class=eb-facet-mobile-close data-ng-click=\"$ctrl.ebFeatures.bodyFacetsOpenClose ? $ctrl.toggleFacet($ctrl.facet) : false\"></button> <span class=eb-facet-mobile-tittle>{{('FACET_TITLE.' + ($ctrl.facet.facet | uppercase)) | translate}} </span><button class=eb-facet-mobile-done data-translate=FACETS_OK data-ng-click=\"$ctrl.ebFeatures.bodyFacetsOpenClose ? $ctrl.toggleFacet($ctrl.facet) : false\"></button></div><ul id=eb-facet-{{$ctrl.facet.facet}} class=eb-facet-multicolumn-{{$ctrl.getNumberOfColumns()}} data-ng-class=\"{'eb-facet-overlap': $ctrl.ebFeatures.bodyFacetsOverlap}\"><li data-ng-repeat=\"value in $ctrl.facet.values |orderBy: $ctrl.orderFacetValuesBySelected | limitTo : $ctrl.facetLimit\" data-ng-class=\"{ 'eb-selected' : $ctrl.ebState.isSelectedFilter(value.filter) }\" data-ng-click=\"$ctrl.ebState.addDelFilter(value.filter, $ctrl.facet.facet === $ctrl.ebFeatures.bodyFacetsCategories.external)\" data-ng-include=\"'components/facet/facet-item.html'\"></li><li class=eb-more data-ng-if=\"$ctrl.ebFeatures.bodyFacetsSeeMoreSystem == 'link' && $ctrl.facet.values.length > $ctrl.ebFeatures.bodyFacetsLimit\" data-ng-click=$ctrl.showMoreLessFacets($event) data-translate=FACETS_SHOW_MORE href></li></ul><button class=eb-facet-clear data-ng-if=\"$ctrl.ebFeatures.bodyFacetsClear && $ctrl.ebState.isDirtyFilter($ctrl.facet)\" data-translate=FACET_CLEAR data-ng-click=$ctrl.ebState.clearFilter($ctrl.facet)></button></div>");
}]);

angular.module("components/facets/facets.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("components/facets/facets.html",
    "<section id=eb-facets-block data-ng-class=\"{'eb-facets-responsive-overlap': $ctrl.ebFeatures.bodyFacetsResponsiveOverlap}\" data-ng-if=\"$ctrl.ebSearch.getAvailableFacets().length > 0\"><div class=eb-facet-darkness></div><button class=eb-facets-ok data-translate=FACETS_OK data-ng-click=$ctrl.toggleFacets() data-ng-if=$ctrl.ebFeatures.bodyFacetsResponsiveOverlap></button><data-eb-facet class=eb-nav-facet data-ng-repeat=\"facet in $ctrl.ebSearch.getAvailableFacets() | filter: $ctrl.categoriesFilter track by facet.facet\" data-facet=facet></data-eb-facet><data-eb-facet class=eb-nav-facet data-ng-class=\"{'eb-facet-scroll': $ctrl.ebFeatures.bodyFacetsSeeMoreSystem === 'scroll'}\" data-ng-repeat=\"facet in $ctrl.ebSearch.getAvailableFacets() | filter: $ctrl.facetsFilter track by facet.facet\" data-facet=facet></data-eb-facet><data-eb-price-facet id=eb-price-facet class=eb-nav-facet data-ng-if=$ctrl.ebFeatures.bodyFacetsPriceRange data-ng-repeat=\"facet in $ctrl.ebSearch.getAvailableFacets() | filter: $ctrl.priceFilter track by facet.facet\" data-facet=facet></data-eb-price-facet></section>");
}]);

angular.module("components/no-results/no-results.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("components/no-results/no-results.html",
    "<data-ng-include data-ng-if=$ctrl.ebFeatures.icons.showNoResultsIcon data-src=$ctrl.noResultsIconPath></data-ng-include><p class=eb-no-results-message data-translate=RESULTS_NORESULTS data-translate-value-query={{$ctrl.showQuery()}}></p><div class=eb-no-results-try-again data-translate=TRY_AGAIN></div><div class=eb-top-clicked data-ng-if=\"$ctrl.ebSearch.getTopClicked().length > 0\"><p class=eb-top-clicked-message data-translate=TOP_CLICKED></p><div id=eb-top-clicked-articles class=eb-top-clicked-list><data-slick data-infinite=true data-slides-to-show=5 data-slides-to-scroll=5 data-speed=1000 data-easing=\"ease out\" data-arrows=true data-init-onload=true data-data=$ctrl.ebSearch.getTopClicked() data-responsive=$ctrl.breakpoints data-autoplay=false><div ng-repeat=\"result in $ctrl.getTopClicked() track by result.id\"><data-eb-result class=\"eb-result {{ $ctrl.ebComponentRenderingHelper.ebResult.getClass() }}\" data-ng-animate=\"'animate'\" data-position={{$index}} data-eb-position=$index data-eb-result=result></data-eb-result></div></data-slick></div></div>");
}]);
...
angular.module("components/scroll-to-top/scroll-to-top.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("components/scroll-to-top/scroll-to-top.html",
    "<div id=eb-scroll-to-top-button data-ng-click=$ctrl.scrollToTop()></div>");
}]);

angular.module("components/sort/sort.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("components/sort/sort.html",
    "<div class=eb-sort-darkness></div><label data-ng-if=!$ctrl.ebFeatures.icons.showSortIcon class=eb-sort-label data-translate=SORT.LABEL data-ng-click=\"$ctrl.ebFeatures.bodyFacetsOpenClose ? $ctrl.toggleSort() : false\"></label><div id=eb-sort-list data-ng-if=\"$ctrl.ebFeatures.components.sort.type === 'list'\"><p id=eb-sort-selected data-ng-click=\"$ctrl.ebFeatures.bodyFacetsOpenClose ? $ctrl.toggleSort() : false\">&nbsp; {{$ctrl.sortLabel}}</p><data-ng-include data-ng-if=$ctrl.ebFeatures.bodyFacetsOpenClose data-ng-class=$ctrl.ebFeatures.icons.toggleFacetAnimation data-src=$ctrl.toggleIconPath></data-ng-include><ul data-ng-class=\"{'eb-collapsed': $ctrl.isCollapsed()}\"><li id=eb-sort-mobile-header><span class=eb-sort-mobile-tittle>{{ 'SORT.LABEL' | translate}} </span><button class=eb-sort-mobile-close data-ng-click=\"$ctrl.ebFeatures.bodyFacetsOpenClose ? $ctrl.toggleSort() : false\">{{'SORT.CLOSE' | translate}}</button></li><li data-ng-repeat=\"element in $ctrl.ebFeatures.components.sort.values track by element.id\" data-ng-click=$ctrl.listElementClick(element.value) data-ng-class=\"{'eb-radio-selected': $ctrl.isSelectedOption(element.value)}\"><span class=eb-radio-tittle data-translate=SORT.{{element.id}}></span> <span class=eb-radio><span class=eb-radio-icon></span></span></li></ul></div>");
}]);

angular.module("components/spellcheck/spellcheck.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("components/spellcheck/spellcheck.html",
    "<span data-translate=RESULTS_SPELLCHECKED></span> <a class=eb-spellchecked-term data-ng-click=$ctrl.applySpellcheck()>{{$ctrl.showQuery($ctrl.ebSearch.getSpellcheck())}}</a>");
}]);

angular.module("components/userPicker/userPicker.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("components/userPicker/userPicker.html",
    "<div ng-app=ebApp><div ng-controller=\"dataSaveController as dsCtrl\"><input type=image src=https://png.icons8.com/restart/color/48 ng-click=restart()></div></div><div class=\"eb-user-picker-user selectable animated\" data-ng-class=\"{selected: $ctrl.isSelectedUser(user), open:$ctrl.open, detailsOpen: $ctrl.showDetails}\" data-ng-show=\"$ctrl.open || $ctrl.isSelectedUser(user)\" data-ng-repeat=\"user in $ctrl.users\" data-ng-click=$ctrl.clickUser(user);><div class=eb-user-picker-image style=\"background-image: url({{user.img}})\"></div></div><div class=\"eb-user-picker-close animated\" data-ng-show=$ctrl.open data-ng-click=\"$ctrl.open=false\"></div><section class=eb-user-picker-details data-ng-show=\"$ctrl.open && $ctrl.showDetails\"><div class=eb-hide-user-picker-details data-ng-click=\"$ctrl.showDetails=false;\"></div><div class=\"eb-user-picker-details-container eb-scroll\"><div class=eb-user-picker-name>{{$ctrl.selectedUser.name}}</div><div class=column-right><h1>{{$ctrl.getPurchasedProducts().length ? 'Products Purchased' : 'No Products Purchased';}}</h1><img data-ng-repeat=\"product in $ctrl.getPurchasedProducts()\" data-ng-src={{product.image}}></div><div class=column-left><h1>{{$ctrl.getProducts().length ? 'Products Viewed' : 'No Products Viewed';}}</h1><img data-ng-repeat=\"product in $ctrl.getProducts()\" data-ng-src={{product.image}}></div></div></section>");
}]);

angular.module("structure/default/main/main.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("structure/default/main/main.html",
    "<span class=eb-total-results data-ng-show=\"ebSearch.getTotalResults() > 0\" data-ng-class=\"{'eb-body-results-total-results-overlap': ebFeatures.bodyResultsTotalResultsOverlap == true}\" data-translate=RESULTS_FOUND data-translate-value-results={{ebSearch.getTotalResults()}}></span><data-eb-spellcheck id=eb-spellcheck data-ng-if=ebComponentRenderingHelper.ebSpellcheck.show()></data-eb-spellcheck><section id=eb-banners data-ng-if=ebComponentRenderingHelper.ebBanners.show()><data-eb-banner class=eb-banner-item data-ng-animate=\"'animate'\" data-ng-repeat=\"banner in ebLinks.getBanners()\" data-position=\"{{ $index }}\" data-eb-position=$index data-banner=banner></data-eb-banner></section><section id=eb-promoteds data-ng-if=ebComponentRenderingHelper.ebPromoteds.show()><div class=eb-text-recomended data-translate=RESULTS_WE_RECOMMEND></div><div id=eb-promoteds-grid data-ng-class=\"{'eb-motion-grid': ebFeatures.bodyResultsMotion == true}\"><data-eb-promoted class=\"eb-promoted-item {{ ebComponentRenderingHelper.ebPromoted.getClass() }}\" data-ng-animate=\"'animate'\" data-ng-repeat=\"promoted in ebLinks.getPromoteds()\" data-position=\"{{ $index }}\" data-eb-position=$index data-promoted=promoted data-last-page-element></data-eb-promoted></div></section><data-eb-suggestions id=eb-suggestions data-ng-if=ebComponentRenderingHelper.ebSuggestions.show()></data-eb-suggestions><data-eb-no-results id=eb-no-results data-ng-if=ebComponentRenderingHelper.ebNoResults.show()></data-eb-no-results><data-eb-results id=eb-results class={{ebComponentRenderingHelper.ebResults.getClass()}} data-ng-if=ebComponentRenderingHelper.ebResults.show()></data-eb-results><data-ng-include id=eb-loading-spinning-balls data-ng-if=\"ebState.isLoading() && !ebConfig.loadingAnimation\" data-src=loadingPath></data-ng-include><data-ng-include id=eb-loading-custom data-ng-show=\"ebState.isLoading() && ebConfig.loadingAnimation\" data-src=ebConfig.loadingAnimation></data-ng-include><data-eb-scroll-to-top id=eb-scroll-to-top data-ng-if=ebComponentRenderingHelper.ebScrollToTop.show()></data-eb-scroll-to-top>");
}]);

angular.module("structure/default/overlay.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("structure/default/overlay.html",
    "<header id=eb-header class={{ebComponentRenderingHelper.ebHeader.getClass()}} data-ng-if=ebComponentRenderingHelper.ebHeader.show() data-ng-include data-src=ebFeatures.structure.default.header></header><data-eb-empathize id=eb-empathize data-ng-if=ebComponentRenderingHelper.ebEmpathize.render() data-ng-show=ebComponentRenderingHelper.ebEmpathize.show() data-ng-style=ebComponentRenderingHelper.ebEmpathize.styles.get()></data-eb-empathize><aside id=eb-utils-bar data-ng-if=ebComponentRenderingHelper.ebFacets.show() data-ng-include data-src=ebFeatures.structure.default.utilsBar></aside><main id=eb-body class={{ebComponentRenderingHelper.ebBody.getClass()}} data-infinite-scroll><section id=eb-main data-ng-include data-src=ebFeatures.structure.default.main></section></main><data-eb-user-picker id=eb-user-picker></data-eb-user-picker>");
}]);

angular.module("structure/default/utils-bar/utils-bar.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("structure/default/utils-bar/utils-bar.html",
    "<data-eb-facets id=eb-facets></data-eb-facets><button class=eb-refine data-ng-click=ebComponentRenderingHelper.ebFacets.toggle()><span data-translate=FACETS_REFINE_BY></span><data-ng-include data-ng-if=ebFeatures.icons.showFilterIcon data-src=\"'commons/icons/toggle/chevron/chevron.html'\"></data-ng-include></button><data-eb-sort id=eb-sort data-ng-show=\"ebFeatures.showSort && ebSearch.getTotalResults() > 0\"></data-eb-sort>");
}]);

angular.module("commons/icons/checkbox/default/default.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("commons/icons/checkbox/default/default.html",
    "<span class=eb-cbx></span>");
}]);

angular.module("commons/icons/loading/custom/custom.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("commons/icons/loading/custom/custom.html",
